...
insertIntoDataToCity = """
INSERT INTO `city` t1 (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES
	...
	(4079, 'Rafah', 'PSE', 'Rafah', 92020) where 
	t1.id not in (select t2.id from city t2 where t2.id=t1.id);
"""

selectDataSql = "select * from city t where t.id in ('9','123');"
...
# cursor.execute("""
#   delete  from city  where Name in ('Kabul','Qandahar')
# """)
# print('成功删除原有两条数据')
